...
const page = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const apiResponse = await fetch("http://127.0.0.1:5000/detect_landslide", {
        method: "POST",
        headers: {
    ...
    <>
      <MainLayout>
        <div className="overflow-hidden">
          ...
          <div className="max-w-[85rem]  py-32 ">
            <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-0">
              <div className="text-center">
                <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
                  <span className="text-purple-500 pl-20">
                    Landslide Detection
                  </span>
                </h1>
              </div>
                ...
                >
                  <div className="bg-white border py-12 px-5 rounded-lg flex items-center flex-col">
                    <div className="text-red-500 text-lg font-medium mt-2 text-center">
                      Sorry, we couldn't find any features to detect. Try again
                      with another image.
                    </div>
                    <button
                ...
                <div className=" py-10  lg:py-14 mx-auto mx-12">
                  <div className="ml-36 py-14 space-y-12">
                    ...
                    <button
                      ...
                      className="bg-purple-500 w-8/12 lg:w-full py-4 rounded-lg hover:bg-blue-700 text-white"
                    >
                      Detect Landslides
                    </button>
                  </div>
