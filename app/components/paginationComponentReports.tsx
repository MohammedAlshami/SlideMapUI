...
const PaginationComponentReports = ({ currentPage, totalPages }) => {
  ...
  return (
    <nav className="flex justify-between items-center gap-x-1">
      <a
        href={`http://localhost:3000/reports?page=${currentPageInt - 1}`}
...
export default PaginationComponentReports;
