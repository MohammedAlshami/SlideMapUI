          ...
          <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
            <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
              <h2 className="text-2xl text-gray-800 font-bold sm:text-3xl dark:text-gray-200">
                Our Cool And Very Very Nice Features
              </h2>
              ...
              >
                  ...
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        Automatic Landslide Incident Summaries
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        Harness the power of automated algorithms to aggregate
                        and summarize landslide-related news articles, providing
                        concise and informative updates on landslide incidents
                        worldwide.
                      </span>
                    </span>
                  </span>
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        AI-Powered Landslide Reporting
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        Empower users to report landslide incidents
                        effortlessly. Our AI-driven platform automatically
                        analyzes and segments reported landslides, providing
                        valuable insights and enhancing understanding of
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                      AI Landslide Mapping
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                      Utilize advanced AI algorithms to map and pinpoint landslide incidents sourced from news articles. Our software automatically extracts locations from news data, segments landslides using AI techniques, and accurately maps them, providing comprehensive visualization and understanding of landslide-prone areas.
