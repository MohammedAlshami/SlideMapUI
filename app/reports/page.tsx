            ...
            <>
              ...
              {filteredNews.map((news) => (
                <a
                  ...
                  className="relative transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg group flex flex-col h-full border border-gray-500/30 border-4 rounded-xl p-5 dark:border-gray-700 dark:hover:border-transparent dark:hover:shadow-black/[.4] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                >
                  ...
                  <div className="my-6">
                    ...
                    {news.details ? news.details.substring(0, 100) + "..." : "No details available"}
                    </p>
                  </div>
                </a>
              ))}
